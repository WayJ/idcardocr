...
class findidcard:
    ...
    def find(self, img2_name):
        print(u'进入身份证模版匹配流程...')
        img1_name = 'matchimages/idcard_mask.jpg'
        MIN_MATCH_COUNT = 10
    ...
    def img_resize(self, imggray, dwidth):
        ...
        crop = cv2.resize(src=crop, dsize=(dwidth, int(height)),
...
if __name__ == "__main__":
    idfind = findidcard()
    result = idfind.find('matchimages/idcard_mask.jpg', 'testimages/9.jpg')
